...
class MyAppcoran extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePagecoran(),
    );
  }
}

class MyHomePagecoran extends StatefulWidget {
  @override
  _MyHomePageStatecoran createState() => _MyHomePageStatecoran();
}

class _MyHomePageStatecoran extends State<MyHomePagecoran> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
