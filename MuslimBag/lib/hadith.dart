...
class MyApphadith extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePagehadith(),
    );
  }
}

class MyHomePagehadith extends StatefulWidget { 
  @override
  _MyHomePageStatehadith createState() => _MyHomePageStatehadith();
}

class _MyHomePageStatehadith extends State<MyHomePagehadith> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
