...
class MyApptasbih extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      title: 'tasbih', 
      home: MyHomePagetasbih(),
    );
  }
}

class MyHomePagetasbih extends StatefulWidget { 
  @override
  _MyHomePageStatetasbih createState() => _MyHomePageStatetasbih();
}

class _MyHomePageStatetasbih extends State<MyHomePagetasbih> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
